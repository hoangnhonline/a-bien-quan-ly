...
$AllowedTypes = "gif|jpg|png|bmp|flv|wmv|avi|mpg|mp4";
//$AllowedTypes = "*";
...
function getAction()
  ...
  if(sQueryString.indexOf("=")==-1)
    {//no querystring
    sAction="assetmanager1.php?ffilter="+document.getElementById("selFilter").value;
    }
  else
    {
    sAction="assetmanager1.php?"+sQueryString+"&ffilter="+document.getElementById("selFilter").value
    }
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  return sAction;
  }
