...
$AllowedTypes = "pdf|doc|xls|gif|jpg|png|bmp|flv|wmv|avi|mpg|mp4";
//$AllowedTypes = "*";
...
function selectFile(index)
  ...
  parent.fileclick(document.getElementById("inpSource").value);
