...
lang : {
	...
	loadingText : 'Loading...',
	loadingTitle : 'Click cancel',
	focusTitle : 'Click to show the front-end',
	fullExpandTitle : 'extended to the actual size (F keys)',
	creditsText : '<i> Copping right: AnhQuanCenter </ i >',
	creditsTitle : 'Click into the Home', 
	previousText : 'Previous at a',
	nextText : 'Next', 
	moveText : 'Move',
	closeText : 'Close', 
	closeTitle : 'Close (ESC key)', 
	resizeTitle : 'Adjustment',
	playText : 'Player',
	playTitle : 'play slide (space bar)',
	pauseText : 'Pause',
	pauseTitle : 'Slide to Pause (space bar)', 
	previousTitle : 'On a (left arrow keys)',
	nextTitle : 'Next (right arrow keys)', 
	moveTitle : 'Move',
	fullExpandText : 'View full-size',
	number: 'Image %1 of %2',
	restoreTitle : 'Click to close picture, click and drag removable picture. Use the keyboard arrow keys can be found on or under a picture. '
},
