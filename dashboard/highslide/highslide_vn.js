...
// Language strings
lang : {
	cssDirection: 'ltr',   // Do not change! 
	loadingText : 'Đang tải...',
	loadingTitle : 'Nhấp chuột để thoát',
	focusTitle : 'Nhấp chuột để xem',
	fullExpandTitle : 'Mở rộng để xem kích cỡ thực (phím F)',
	creditsText : '<i> Bản quyền thuộc về: tiun.us </ i >',
	creditsTitle : 'Nhấp chuột để tới trang', 
	previousText : 'Ảnh kế trước',
	nextText : 'Trước', 
	moveText : 'Di chuyển',
	closeText : 'Thoát', 
	closeTitle : 'Thoát (phím ESC)', 
	resizeTitle : 'Adjustment',
	playText : 'Chạy',
	playTitle : 'Tự chuyển ảnh (space bar)',
	pauseText : 'Dừng',
	pauseTitle : 'Dừng chuyển ảnh (space bar)', 
	previousTitle : 'Xem từng ảnh một (left arrow keys)',
	nextTitle : 'Ảnh kế tiếp (nhấn phím mũi tên sang phải)', 
	moveTitle : 'Di chuyển',
	fullExpandText : 'Xem cỡ lớn',
	number: 'Image %1 of %2',
	restoreTitle : 'Nhấn chuột vào đây để thoát ảnh, hình dấu + để di chuyển ảnh, hình mũi tên sang trái để xem ảnh trước, hình mũi tên sang phải để xem ảnh sau, hình dấu x để thoát.'
},
...
creditsHref : 'http://anhquancenter.com', //Hiển thị links tới web
